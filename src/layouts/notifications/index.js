              ...
              <Box p={2}>
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6} lg={3}>
                    <Button variant="gradient" color="success" onClick={openSuccessSB} fullWidth>
                      success notification
                    </Button>
                    {renderSuccessSB}
                  </Grid>
                  <Grid item xs={12} sm={6} lg={3}>
                    <Button variant="gradient" color="info" onClick={openInfoSB} fullWidth>
                      info notification
                    </Button>
                    {renderInfoSB}
                  </Grid>
                  <Grid item xs={12} sm={6} lg={3}>
                    <Button variant="gradient" color="warning" onClick={openWarningSB} fullWidth>
                      warning notification
                    </Button>
                    {renderWarningSB}
                  </Grid>
                  <Grid item xs={12} sm={6} lg={3}>
                    <Button variant="gradient" color="error" onClick={openErrorSB} fullWidth>
                      error notification
                    </Button>
                    {renderErrorSB}
                  </Grid>
